// Archivo principal de configuración para las descripciones de las habilidades
// Este archivo importa y combina las descripciones de todos los archivos parciales

import { skillDescriptionsPart1 } from './skillDescriptionsPart1';
import { skillDescriptionsPart2 } from './skillDescriptionsPart2';
import { skillDescriptionsPart3 } from './skillDescriptionsPart3';
import { skillDescriptionsPart4 } from './skillDescriptionsPart4';
...
// Combinamos todas las descripciones de habilidades en un solo objeto
export const skillDescriptions: SkillDescriptions = {
  ...skillDescriptionsPart1,
  ...skillDescriptionsPart2,
  ...skillDescriptionsPart3,
  ...skillDescriptionsPart4,
  // Mantenemos las descripciones ya existentes en skillDescriptions.ts
  'HTML': {
