...
const Carousel: React.FC<Props> = ({ images }) => {
  ...
  return (
    <div className="rounded-lg relative w-full overflow-hidden" data-carousel="slide">
      <div
      ...
      >
        {images.map((image, index) => (
          <div className="flex-shrink-0 w-full h-56 md:h-96" data-carousel-item key={index}>
            <img
              src={image}
